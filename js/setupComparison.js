...
function setupComparison() {
	...
	if (chosenPeerGroup.length === 0) {
		...
		d3.select(".namePro").text("Nog niet te meten totdat je minstens 18 bent");
		d3.select(".radarChartTitle").text("");
		d3.select(".golfProStats").style("display","none");
		d3.select(".explanation").text("");
			
		//Change the image of the Pro golfer
		d3.select(".ProImage").attr("src", "img/noPeerGroup.jpg");
